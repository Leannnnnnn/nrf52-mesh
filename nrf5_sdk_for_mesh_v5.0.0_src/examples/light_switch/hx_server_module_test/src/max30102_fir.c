...
uint32_t numBlocks = BLOCK_SIZE;            /* arm_fir_f32 */
arm_fir_instance_f32 S_ir,S_red;
static float firStateF32_ir[BLOCK_SIZE + NUM_TAPS - 1];        /* numTaps + blockSize - 1*/
static float firStateF32_red[BLOCK_SIZE + NUM_TAPS - 1];        /* numTaps + blockSize - 1*/
/*  fadtool*/
